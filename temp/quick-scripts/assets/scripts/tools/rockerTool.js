(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/tools/rockerTool.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '90b89nbge9DGKHZm7BnfhBX', 'rockerTool', __filename);
...
cc.Class({
    ...
    onMove: function onMove(event) {
        //摇杆跟随逻辑
        var pos = this.panelNode.convertToNodeSpaceAR(event.getLocation());
        ...
        if (radius <= this.backgroundNode.width / 2) {
            ...
            var posX = Math.cos(Math.atan2(pos.y, pos.x)) * (this.backgroundNode.width / 2);
            var posY = Math.sin(Math.atan2(pos.y, pos.x)) * (this.backgroundNode.width / 2);
    ...
    fourOrientationExcute: function fourOrientationExcute() {
        if (this.angle > 45 && this.angle < 135) {
            ...
            //下
            this.bodyObj.y -= this.speed;
        } else if (this.angle < -135 && this.angle > -180 || this.angle > 135 && this.angle < 180) {
            //左
            this.bodyObj.x -= this.speed;
        } else if (this.angle < 0 && this.angle > -45 || this.angle > 0 && this.angle < 45) {
            //右
            this.bodyObj.x += this.speed;
        }
    },

    allOrientationExcute: function allOrientationExcute() {
        if (this.angle === 0) {
            return;
        }
    ...
    eightOrientationExcute: function eightOrientationExcute() {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=rockerTool.js.map
